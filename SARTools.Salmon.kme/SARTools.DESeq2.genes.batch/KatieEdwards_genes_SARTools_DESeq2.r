...
workDir <- "C:/Users/Katie/Desktop/College Work/Spring 2019/BIOL 364/RNASeqProject/SARTools/SARTools.DESeq2.genes.batch"      # working directory for the R session

projectName <- "SARTools.DESeq2.genes"                         # name of the project
author <- "Katie Edwards"                                # author of the statistical analysis/report
